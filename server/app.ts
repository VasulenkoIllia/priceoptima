...
export function createApp(): Express {
  ...
  // прайс файлом і велика заявка розбирають тіло самі, після перевірки входу (http/bodyLimits)
  app.use('/api', apiJson, cookieParser(config.SESSION_SECRET), apiRouter);
