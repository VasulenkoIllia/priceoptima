...
export const TEMPLATE_COLUMNS: readonly TemplateColumn[] = [
  ...
  { header: 'Ціна закупівлі без ПДВ', width: 22, required: true, note: 'Ваша відпускна ціна без ПДВ, у валюті прайсу. Якщо ціни у вас із ПДВ — напишіть це в листі, ми перерахуємо при завантаженні.' },
...
const EXAMPLE_ROWS: (string | number)[][] = [
  ['ТА-100234', 'VT.214.N.05', 'Кран кульовий 1/2" в-в, ручка-метелик', 'VALTEC', 'шт', 182.5, 'UAH', 329, '100+', 1, 1, 2],
  ['ТА-100987', '', 'Труба ППР PN20 D20, 4 м', 'Blue Ocean', 'м', 24.9, 'UAH', 45, '30+', 4, 20, 3],
];
...
const INSTRUCTIONS_INTRO: [string, string][] = [
  ...
  ['Обов’язкові колонки', 'Код постачальника, Назва, Ціна закупівлі без ПДВ. Рядки без коду або без ціни ми пропускаємо.'],
